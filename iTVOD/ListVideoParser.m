...
@implementation ListVideoParser
...
- (void) connection:(NSURLConnection *)connection didFailWithError:(NSError *)error{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:GET_LIST_VIDEO_CONNECTION_FAILED object:nil];
...
-(void) connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    if ((json_string == nil) || (json_string == @"") || [json_string isEqualToString:@""]) {
         ...
         [[NSNotificationCenter defaultCenter]postNotificationName:GET_LIST_VIDEO_ERROR object:nil];
...
//            [[NSNotificationCenter defaultCenter]postNotificationName:GET_LIST_VIDEOS_BY_DRAMA_ERROR object:nil];
        ...
        if (_listVideoObj.success) {
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:GET_LIST_VIDEO_OK object:nil];
